...
export const scannerResultTypeToEncryption: { value: string; label: string }[] = [
  { value: "1", label: i18n.t("app.new_code.qr_code_form.encryption.options.none") },
  { value: "2", label: i18n.t("app.new_code.qr_code_form.encryption.options.wpa") },
  { value: "3", label: i18n.t("app.new_code.qr_code_form.encryption.options.wep") },
];

export const textOptions: { value: string; label: string }[] = [
  { value: "bottom", label: i18n.t("app.new_code.barcode_form.text.options.bottom") },
